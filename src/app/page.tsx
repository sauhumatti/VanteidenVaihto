                    ...
                    <div className="max-w-3xl mx-auto">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
                             ...
                             <div className="relative h-[300px] md:h-[450px] bg-gray-100 rounded-lg overflow-hidden border border-gray-200 text-gray-500">
                                 ...
                                 ) : !detectedWheels && !isLoadingDetection && !error ? ( <div className="flex items-center justify-center h-full"> <Image src={mainImagePreviewUrl} alt="Original car" fill className="object-contain opacity-50" /> <div className="relative z-10 p-4 bg-white/80 rounded shadow"><p className="mt-2 text-gray-600 font-medium">Click &quot;Detect Wheels&quot;</p></div> </div>
                                 ...
                                 ) : outputImageUrl ? ( <Image src={outputImageUrl} alt="Car with swapped wheels" fill className="object-contain" />
                                 ) : detectedWheels && !outputImageUrl && !isCompositing && !error ? ( <div className="flex flex-col items-center justify-center h-full"> {resizedImageDataUrl && <Image src={resizedImageDataUrl} alt="Detected car" fill className="object-contain opacity-70" />} <p className="relative z-10 text-center px-4 p-2 bg-white/80 rounded shadow">Select replacement wheels below.</p> </div>
                                 ) : null}
                                        ...
                                        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
                                            {availableWheels.map((wheel) => (
                                                <button
                                                    ...
                                                    title={wheel.name}
                                                >
                                                    <div className="aspect-square w-full bg-gray-50 flex items-center justify-center p-1">
                                                         <Image
                                                            src={wheel.imageUrl}
                                                            alt={wheel.name}
